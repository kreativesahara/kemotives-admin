    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                // Fallback data for demonstration: generate 100 mock products
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="mt-4 text-sm text-gray-500">
                        Showing {Math.min((currentPage - 1) * ITEMS_PER_PAGE + 1, totalItems)} to {Math.min(currentPage * ITEMS_PER_PAGE, totalItems)} of {totalItems} products
                    </div>
                </>
            )}
        </div>
